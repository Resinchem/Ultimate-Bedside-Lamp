...
3. Check any additional groups you wish to add, or uncheck groups you wish to hide.
...
| :--- | :--- | :--- |
| **RGBW Light Bulb** | `light.device_name_bulbstate`<br>*(Includes brightness, color, and temperature)* | Light Bulb |
| **LED Strip** | `light.device_name_ledstate`<br>*(Includes brightness and color)* | LED Strip |
