...
*If the driver pages appear in Chinese, right-click and select "Translate to English" in your browser, or look for the "down arrow" (↓) download button.*
...
* **Proximity:** The ESP32 doesn't have the broadcasting power of a high-end router. Stay in the same room as the controller during this process.
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 40px; border-top: 1px solid #333; padding-top: 20px;">
  <a href="{{ '/troubleshooting' | relative_url }}" class="btn btn-outline"><- Previous: Troubleshooting</a>
